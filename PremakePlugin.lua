...
local Plugin = {}
Plugin.name = "Generic_UI_for_Csound"
Plugin.factoryheader = "../SoundEnginePlugin/Generic_UI_for_CsoundSourceFactory.h"
Plugin.appleteamid = ""
Plugin.sdk = {}
Plugin.sdk.static = {}
Plugin.sdk.shared = {}
...
{
    "Generic_UI_for_CsoundSourceShared.cpp"
}
...
{
    "Generic_UI_for_CsoundSourceShared.cpp",
    "Generic_UI_for_CsoundSourceFactory.h",
}
...
Plugin.authoring.files =
{
    ...
    "**.hpp",
    "**.c",
    "Generic_UI_for_Csound.def",
    "Generic_UI_for_Csound.xml",
    "**.rc",
    "Generic_UI_for_Csound.rc",
    "resource.h",
}
