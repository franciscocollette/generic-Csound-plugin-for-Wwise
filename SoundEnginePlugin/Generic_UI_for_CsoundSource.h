...
#ifndef Generic_UI_for_CsoundSource_H
#define Generic_UI_for_CsoundSource_H
...
class Generic_UI_for_CsoundSource
    : public AK::IAkSourcePlugin
{
public:
    Generic_UI_for_CsoundSource();
    ~Generic_UI_for_CsoundSource();
