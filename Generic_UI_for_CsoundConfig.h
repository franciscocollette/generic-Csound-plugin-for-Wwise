...
#ifndef Generic_UI_for_CsoundConfig_H
#define Generic_UI_for_CsoundConfig_H
...
namespace Generic_UI_for_CsoundConfig
{
    static const unsigned short CompanyID = 64;
    static const unsigned short PluginID = 1661;
}

#endif // Generic_UI_for_CsoundConfig_H
